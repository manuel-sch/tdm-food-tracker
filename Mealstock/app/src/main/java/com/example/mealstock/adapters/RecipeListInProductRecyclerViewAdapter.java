...
public class RecipeListInProductRecyclerViewAdapter extends RecyclerView.Adapter<RecipeListInProductRecyclerViewAdapter.RecipeItemViewHolder> {

    private Context context;
    private List<Recipe> recipes;
    private final RecipeItemClickListener clickListener;

    public RecipeListInProductRecyclerViewAdapter(RecipeItemClickListener clickListener) {
